...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	private boolean ifPullLoad = true;

	private boolean ifSetPullChange = false;
	private boolean setPullChange = false;
	...
	public void hidePullLaod() {
		if(loadmoreView!=null){
			RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams)loadmoreView.getLayoutParams();
			lp.height = 0;
			loadmoreView.setLayoutParams(lp);
		}else{
			ifSetPullChange = true;
			setPullChange = false; 
		}
	 ...
	 * show footer
	 */
	public void showPullLaod() {
		Log.d(TAG, "showPullLaod-loadmoreView="+loadmoreView);
		if(loadmoreView!=null){
			RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams)loadmoreView.getLayoutParams();
